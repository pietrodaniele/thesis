...
void last_ph_cutFlow(){
  // write the results file
  ofstream write; //ofstream is the class for fstream package
  write.open("Fit_Results/fit_res_last_ph_cutFlow.txt"); //open is the method of ofstream
  // TCanvas
  ...
  // adding text
  TPaveText *text_cut = new TPaveText(0.05,0.88,0.77,0.98,"brNDC");
  ...
  line->Draw();
  // saving plot
  c1->SaveAs("Plots/myy_140GeV_DCBfit_cutFlow.pdf");
  return;
}
