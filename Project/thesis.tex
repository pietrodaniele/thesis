...
\begin{document}
	...
	\chapter{LHC and ATLAS Detector}
		...
		\section{ATLAS}
			...
			\subsection{Muon system}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.7\textwidth]{thesis_images/3D-muon.jpg}
			...
			\subsection{Trigger system}
				...
				\begin{figure}
					\centering
					\subfloat[]{\includegraphics[width=.49\textwidth]{thesis_images/L1.png}}					\subfloat[]{\includegraphics[width=.49\textwidth]{thesis_images/HLT.png}} 
	...
	\chapter{Photon reconstruction and selection}
