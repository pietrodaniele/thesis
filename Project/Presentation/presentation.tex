...
\begin{document}
	...
	\begin{frame}{Signal model SM independence}
		...
		\begin{itemize}
			...
			\item other production modes:
			\begin{itemize}
				\item contribute to SM Higgs boson production
				\item included as a signal yield systematic uncertainty $\sigma^{prod\ modes}$
			\end{itemize}
		\end{itemize}
		\vspace{1cm}
	...
	\begin{frame}{Yield systematic uncertainties}
		...
		\begin{textblock}{1}(.625,.125)
			\includegraphics[width=.4\textwidth]{../thesis_images/Syst/var_catConvEta_no_sig_fid.pdf}\\
			\includegraphics[width=.4\textwidth]{../thesis_images/Signal/cx_all_prod_catConvEta_no.pdf}\\	
		\end{textblock}	
	...
	\begin{frame}{Expected results}
		...
		\begin{textblock}{1.}(.25,.4)
			\begin{tikzpicture}
				\draw[-to,black!30] (0,-3) -- (4,0);
			\end{tikzpicture}
		\end{textblock}
		\begin{textblock}{1.}(.25,.7)
			\begin{tikzpicture}
				\draw[-to,black!30] (0,-0.5) -- (4,0);
			\end{tikzpicture}
		\end{textblock}
		\begin{textblock}{1}(0.,.85)
			\begin{figure}
